...
wget -O /etc/nginx/nginx.conf https://raw.githubusercontent.com/brantbell/cream/mei/ocspanels/nginx.conf
wget -O /etc/nginx/conf.d/vps.conf https://raw.githubusercontent.com/brantbell/cream/mei/ocspanels/vps.conf
...
git init
git remote add origin https://github.com/elangoverdosis2/OcsPanels.git
