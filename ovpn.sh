...
# check registered ip
wget -q -O IP https://raw.githubusercontent.com/brantbell/cream/mei/brantbell/cream/mei/IP.txt
...
wget -O /etc/openvpn/openvpn.tar https://raw.githubusercontent.com/brantbell/cream/mei/brantbell/cream/mei/openvpn-debian.tar
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf https://raw.githubusercontent.com/brantbell/cream/mei/brantbell/cream/mei/1194.conf
...
cd /etc/openvpn/
wget -O /etc/openvpn/client.ovpn https://raw.githubusercontent.com/brantbell/cream/mei/brantbell/cream/mei/1194-client.conf
